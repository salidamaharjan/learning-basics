...
$(function () {
  ...
  function createRow(hour) {
    ...
    var $timeRow = $(`<div id="hour-${hour}" class="row time-block ${isPastPresentFuture(hour)}">
  ...
  function isPastPresentFuture(hour){
    var dayjsHour = dayjs().format('HH');
    console.log("dayjsHour ", dayjsHour);
   if(hour === dayjsHour) {
     return  "present";
   } else if (hour < dayjsHour){
    return "future";
   } else {
    return  "past";
   }
